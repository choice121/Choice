...
for pid in ["242fc8dd-b96e-46e1-8b16-24a208b09cc9", "627344dc-6ccb-4fa8-92e6-c7f8fdbd69a9"]:
    ...
    print(f"\nProperty {pid} photos count: {len(photos)}")
    if photos:
        print("  Hero photo:", photos[0].get("url"))
        print("  Alt text:", photos[0].get("alt_text"))
