-- Fix pipeline_publish: restore correct amenities cast (text[] not jsonb)
-- and add listed_at + source_status columns to the INSERT.
-- Overwrites the broken version from 20260624000002.
