      ...
      <main className="flex-1">
        ...
        <section id="how-to-apply-hero" className="relative overflow-hidden border-b border-slate-200/80 bg-gradient-to-b from-slate-100 via-slate-950 to-slate-950 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-4xl text-center space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-zillow-green/30 bg-zillow-green/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-wider text-zillow-green-dark">
              Renter Guide &amp; Process
            </div>
            <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900">
              Apply Online in <span className="text-transparent bg-clip-text bg-gradient-to-r from-zillow-blue to-emerald-400">15 Minutes</span>
            </h1>
        ...
        <section id="application-steps-section" className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
          ...
          <div id="interactive-checklist-card" className="rounded-2xl border border-slate-200 bg-white/90 p-6 sm:p-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-slate-100/80 px-4 py-2 text-xs font-semibold text-zillow-blue">
                ...
                return (
                  <button
                    ...
                    className={`flex items-start gap-3 rounded-xl border p-4 text-left transition ${
                      isChecked
                        ? 'border-zillow-green/40 bg-zillow-green/10'
                  ...
                  >
                    <div
                      className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md border mt-0.5 text-xs font-bold transition ${
                        isChecked
                          ? 'border-zillow-green bg-zillow-green text-slate-950'
                    ...
                    <div>
                      <span className={`block text-sm font-bold ${isChecked ? 'text-zillow-green-dark' : 'text-slate-900'}`}>
                        {item.label}
                      </span>
          ...
          <div id="fee-transparency-card" className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-6 space-y-2">
              <span className="text-xs uppercase tracking-wider font-semibold text-zillow-blue">Screening Fee</span>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-6 space-y-2">
              <span className="text-xs uppercase tracking-wider font-semibold text-zillow-green-dark">Security Deposit</span>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-6 space-y-2">
              <span className="text-xs uppercase tracking-wider font-semibold text-zillow-blue">Pet Guarantee</span>
          ...
          {/* Action CTA Banner */}
          <div id="how-to-apply-cta-banner" className="rounded-2xl border border-zillow-blue/30 bg-gradient-to-r from-slate-100 via-white to-zillow-blue/5 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
