        ...
        <section id="application-steps-section" className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
          ...
          <div id="interactive-checklist-card" className="rounded-2xl border border-slate-200 bg-white/90 p-6 sm:p-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-slate-100/80 px-4 py-2 text-xs font-semibold text-cyan-300">
              ...
              {checklist.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <span className={`block text-sm font-bold ${isChecked ? 'text-emerald-300' : 'text-slate-900'}`}>
                        {item.label}
                      </span>
          ...
          {/* Action CTA Banner */}
          <div id="how-to-apply-cta-banner" className="rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-slate-100 via-white to-cyan-950/40 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
