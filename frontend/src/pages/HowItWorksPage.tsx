...
export function HowItWorksPage() {
  return (
    <div id="how-it-works-page-container" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      <Navbar />

      <main className="flex-1">
        {/* Hero Section */}
        <section id="how-it-works-hero" className="relative overflow-hidden border-b border-slate-800/80 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-4xl text-center space-y-4">
            ...
            <div className="pt-4 flex flex-wrap justify-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-cyan-900/40 transition hover:brightness-110 min-h-[44px]"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl border border-slate-700 bg-slate-900 px-6 py-3.5 text-sm font-bold text-slate-200 transition hover:bg-slate-800 hover:text-white min-h-[44px]"
              >
        ...
        <section id="landlord-steps-section" className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold text-white">A Seamless Landlord Workflow</h2>
            <p className="text-sm sm:text-base text-slate-400">Everything from marketing to move-in coordinated through your dashboard.</p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 space-y-3">
              ...
              <h3 className="text-lg font-bold text-white">List Your Property</h3>
              <p className="text-sm text-slate-300 leading-relaxed">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 space-y-3">
              ...
              <h3 className="text-lg font-bold text-white">Screened Applicants</h3>
              <p className="text-sm text-slate-300 leading-relaxed">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 space-y-3">
              ...
              <h3 className="text-lg font-bold text-white">Select &amp; Sign</h3>
              <p className="text-sm text-slate-300 leading-relaxed">
          ...
          {/* Benefits Grid */}
          <div id="landlord-benefits-card" className="rounded-2xl border border-slate-800 bg-slate-900/90 p-8 space-y-6">
            <h3 className="text-2xl font-bold text-white">Why Property Owners Trust Choice Properties</h3>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2">
                ...
                <h4 className="text-base font-bold text-white">Zero Subscription Fees</h4>
              ...
              <div className="space-y-2">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 font-bold text-sm">✓</span>
                <h4 className="text-base font-bold text-white">Comprehensive Screening</h4>
                <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="space-y-2">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 font-bold text-sm">✓</span>
                <h4 className="text-base font-bold text-white">Standard 1× Rent Security</h4>
                <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="space-y-2">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 font-bold text-sm">✓</span>
                <h4 className="text-base font-bold text-white">Dedicated Support Coordinator</h4>
                <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="space-y-2">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 font-bold text-sm">✓</span>
                <h4 className="text-base font-bold text-white">Digital Lease Management</h4>
                <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="space-y-2">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 font-bold text-sm">✓</span>
                <h4 className="text-base font-bold text-white">Equal Housing Compliance</h4>
                <p className="text-xs text-slate-300 leading-relaxed">
          ...
          {/* Bottom CTA */}
          <div id="landlord-bottom-cta" className="rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-slate-900 via-slate-900 to-cyan-950/40 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2 text-center md:text-left">
              <h3 className="text-2xl font-bold text-white">Ready to fill your vacancies faster?</h3>
