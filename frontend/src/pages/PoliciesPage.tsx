...
export function PoliciesPage() {
  ...
  return (
    <div id="policies-page-container" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      <Navbar />

      <main className="flex-1">
        {/* Header */}
        <section className="border-b border-slate-800/80 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 space-y-12">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {policies.map((p) => (
              <Link
                key={p.path}
                to={p.path}
                className="group flex flex-col justify-between rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-md transition hover:border-cyan-500/50 hover:bg-slate-850"
              >
                <div className="space-y-3">
                  <span className="inline-block rounded-md bg-cyan-500/10 border border-cyan-500/30 px-2.5 py-0.5 text-xs font-semibold text-cyan-300">
                    {p.tag}
                  </span>
                ...
                <div className="pt-4 text-xs font-semibold text-cyan-400 group-hover:translate-x-1 transition flex items-center gap-1">
                  Read full policy →
                </div>
              </Link>
            ))}
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-8 space-y-6">
            <h3 className="text-2xl font-bold text-white">Our 3 Core Market Guarantees</h3>
            <div className="grid gap-6 sm:grid-cols-3 text-sm text-slate-300">
              <div className="space-y-1.5 border-l-2 border-cyan-500 pl-4">
                <h4 className="font-bold text-white text-base">Standard $50 Fee</h4>
              ...
              <div className="space-y-1.5 border-l-2 border-emerald-500 pl-4">
                <h4 className="font-bold text-white text-base">1× Security Deposit</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="space-y-1.5 border-l-2 border-cyan-400 pl-4">
                <h4 className="font-bold text-white text-base">100% Pet Friendly</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
