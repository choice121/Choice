          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {policies.map((p) => (
              <Link
                key={p.path}
                to={p.path}
                className="group flex flex-col justify-between rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-md transition hover:border-cyan-500/50 hover:bg-slate-850"
              >
                <div className="space-y-3">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 group-hover:text-cyan-300 transition">
                    {p.title}
                  </h2>
