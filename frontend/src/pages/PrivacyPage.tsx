...
export function PrivacyPage() {
  return (
    <div id="privacy-page-container" className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between">
      <Navbar />
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/70 p-6 sm:p-8 space-y-6 leading-relaxed text-sm sm:text-base text-slate-600">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-600">
                <li><strong className="text-slate-900">Applicant Intake:</strong> Full legal name, date of birth, email address, phone number, current and past residential addresses, employment history, and monthly income details.</li>
                <li><strong className="text-slate-900">Social Security Information:</strong> To protect applicant confidentiality, full Social Security Numbers are never stored in plaintext across our primary databases. Verification is conducted through encrypted credit bureau channels.</li>
                <li><strong className="text-slate-900">Supporting Documentation:</strong> Pay stubs, government IDs, and verification letters uploaded during the application process are transmitted via TLS 1.3 encryption.</li>
                <li><strong className="text-slate-900">Technical &amp; Analytics Data:</strong> IP address, device type, browser metadata, and session cookies used exclusively to safeguard system integrity and prevent fraudulent bot submissions.</li>
              </ul>
            </div>
