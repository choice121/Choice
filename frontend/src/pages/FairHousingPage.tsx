...
export function FairHousingPage() {
  return (
    <div id="fair-housing-page-container" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      <Navbar />
      ...
      <main className="flex-1">
        ...
        <section className="border-b border-slate-800/80 bg-gradient-to-b from-slate-900 to-slate-950 px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl space-y-4">
            <nav className="flex items-center gap-2 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
              ...
              <span>›</span>
              <span className="text-slate-200" aria-current="page">Fair Housing Policy</span>
            </nav>
        ...
        <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 space-y-6 leading-relaxed text-sm sm:text-base text-slate-300">
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">2. Federal Fair Housing Act Compliance</h2>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-1 text-slate-300">
                <li><strong className="text-white">Race</strong></li>
                <li><strong className="text-white">Color</strong></li>
                <li><strong className="text-white">National Origin</strong></li>
                <li><strong className="text-white">Religion</strong></li>
                <li><strong className="text-white">Sex</strong> (including gender identity and sexual orientation)</li>
                <li><strong className="text-white">Familial Status</strong> (including families with children under 18 and pregnant individuals)</li>
                <li><strong className="text-white">Disability</strong> (physical or mental impairments)</li>
              </ul>
            </div>

            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">3. State and Local Law Protections</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">4. Prohibited Actions on Choice Properties</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">5. Reporting Violations</h2>
              <p>
