...
export function RentalApplicationPolicyPage() {
  return (
    <div id="rental-policy-page-container" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      <Navbar />
        ...
        <section className="border-b border-slate-800/80 bg-gradient-to-b from-slate-900 to-slate-950 px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl space-y-4">
            <nav className="flex items-center gap-2 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
              ...
              <span>›</span>
              <span className="text-slate-200" aria-current="page">Rental Application Policy</span>
            </nav>
        ...
        <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 space-y-6 leading-relaxed text-sm sm:text-base text-slate-300">
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">1. Overview &amp; Process</h2>
              <p>
              ...
              <ol className="list-decimal pl-6 space-y-2 text-slate-300 mt-2">
                <li><strong className="text-white">Online Application:</strong> Submit your basic applicant details and documents. No fee is charged at initial submission.</li>
                <li><strong className="text-white">Payment Coordination:</strong> Our leasing desk contacts you within 24 hours to securely coordinate payment of the standard $50 screening fee.</li>
                <li><strong className="text-white">Active Screening Review:</strong> Verified background, eviction history, and credit reports are processed within 24 to 72 hours.</li>
                <li><strong className="text-white">Approval &amp; Selection:</strong> Qualified applicants receive approval notice and digital lease documents.</li>
                <li><strong className="text-white">Move-In Coordination:</strong> Standard 1× rent security deposit is paid and keys are scheduled.</li>
              </ol>
            </div>

            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">2. Application Fee Structure</h2>
              <p>
              ...
              <p>
                <strong className="text-white">Non-Refundability:</strong> Once the screening fee has been authorized and the third-party screening check initiated, the fee is non-refundable. If an application is denied or another applicant is selected first, applicants are eligible for reapplication credits valid for 45 days.
              </p>
            </div>

            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">3. Qualification Standards</h2>
              <ul className="list-disc pl-6 space-y-2 text-slate-300">
                <li><strong className="text-white">Income:</strong> Verifiable gross monthly household income should equal or exceed approximately 3× the monthly rent.</li>
                <li><strong className="text-white">Rental History:</strong> Positive prior tenancy references free from unresolved utility defaults or disruptive lease breaches.</li>
                <li><strong className="text-white">Credit Profile:</strong> Consistent repayment history evaluated in aggregate. Medical debt or disputed student loan balances do not automatically disqualify applicants.</li>
                <li><strong className="text-white">Background Check:</strong> Criminal history reviewed in strict compliance with HUD guidelines and applicable local fair chance housing ordinances.</li>
              </ul>
            </div>

            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">4. Security Deposit Policy</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">5. Equal Opportunity Statement</h2>
              <p>
