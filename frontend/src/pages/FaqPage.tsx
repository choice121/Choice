    ...
    <div id="faq-page-container" className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between">
      ...
      <main className="flex-1">
        ...
        <section id="faq-hero-section" className="relative overflow-hidden border-b border-slate-200/80 bg-gradient-to-b from-slate-100 via-slate-950 to-slate-950 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-4xl text-center space-y-4">
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900">
              Frequently Asked <span className="text-transparent bg-clip-text bg-zillow-blue">Questions</span>
            </h1>
            ...
            <div className="pt-4 max-w-xl mx-auto">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-300 bg-white/90 px-5 py-3.5 pl-12 text-sm text-slate-900 placeholder-slate-400 shadow-inner outline-none transition focus:border-zillow-blue focus:ring-2 focus:ring-zillow-blue/20"
                />
                <svg
        ...
        <section id="faq-content-section" className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
              ...
              <button
                ...
                className={`rounded-xl px-3.5 py-2 text-xs font-semibold transition min-h-[40px] ${
                  selectedCategory === cat.id
                    ? 'bg-zillow-blue text-white shadow-md '
            ...
            {filteredItems.length === 0 ? (
              <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center text-slate-500 space-y-3">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center rounded-xl bg-slate-100 px-4 py-2 text-xs font-semibold text-zillow-blue hover:bg-slate-100 transition"
                >
                  Reset Filters
                </button>
              </div>
                    ...
                    >
                      ...
                      <span
                        className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border transition ${
                          isOpen
                            ? 'border-zillow-blue/50 bg-zillow-blue/10 text-zillow-blue rotate-180'
          ...
          <div id="faq-support-banner" className="rounded-2xl border border-zillow-blue/30 bg-gradient-to-r from-slate-100 via-white to-zillow-blue/5 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-4 pt-1 text-xs text-zillow-blue justify-center md:justify-start">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl bg-zillow-blue px-5 py-3 text-sm font-bold text-white shadow-lg  transition hover:bg-zillow-blue-dark min-h-[44px]"
              >
                Browse Listings
              </Link>
              <a
