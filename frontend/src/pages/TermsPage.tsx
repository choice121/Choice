...
export function TermsPage() {
  return (
    <div id="terms-page-container" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      <Navbar />
        ...
        <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 space-y-6 leading-relaxed text-sm sm:text-base text-slate-300">
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">1. About Choice Properties</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">3. Eligibility &amp; User Conduct</h2>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">4. Application Fees &amp; Deposits</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">5. Equal Housing &amp; Fair Housing</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">6. Limitation of Liability &amp; Dispute Resolution</h2>
              <p>
          ...
          <div className="flex justify-between items-center text-xs text-slate-400 pt-4 border-t border-slate-850">
            <Link to="/privacy" className="hover:text-cyan-300 flex items-center gap-1">
              ← View Privacy Policy
            </Link>
