...
| Phase | Name | Status |
  ...
  | Phase 11 | Archive GAS | **IN PROGRESS** — MIGRATION_new_columns.sql applied 2026-04-18 (15 new columns confirmed live). End-to-end test passed: test application CP-20260418-ISV9DF566 submitted via receive-application Edge Function, landed in Supabase, checkRecentSubmission verified. BACKEND_URL on apply-choice-properties CF Pages confirmed pointing to Supabase Edge Function. Remaining: disable GAS doPost. |
