...
##
## ACTIVE ISSUE TRACKER: read `public.agent_issues` in Supabase before
## writing any code. It is the single source of truth for open work.
## See REPLIT.md for the SQL to read it. Work ONE issue at a time and
## update its row when you ship.
##
## WORKFLOW SUMMARY:
